...
export function AIDisclaimer({ className = '' }: DisclaimerProps) {
  return (
    <div className={`flex items-start gap-2 text-xs text-amber-800 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2 ${className}`}>
      <svg className="w-4 h-4 flex-shrink-0 mt-0.5 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
      </svg>
      <span><strong>Survey-Support Notice:</strong> Outputs represent AI-assisted preliminary cadastral/survey-support results requiring authorized verification. Not a legally admissible or statutory record without authorized surveyor certification.</span>
    </div>
  );
}
