...
Generated by: AI-Enabled Cadastral Mapping Platform (FastAPI / GeoPandas)`;
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-100 text-slate-800 font-sans">
      ...
      {/* Explicit Technical Demo Specification Notice */}
      <div className="bg-amber-950/90 border-b border-amber-500/40 text-amber-200 px-6 py-2 text-xs flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span className="bg-amber-500 text-slate-950 px-1.5 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider">Technical Demo Specification</span>
          <span>This page provides architectural pipeline diagrams, dataflow schematics, and prototype sample outputs for technical demonstration reference.</span>
        </div>
        <span className="text-[10px] font-mono text-amber-400/80">Non-Operational Sandbox Reference</span>
      </div>
